...
public class MainClass {
	...
	public static void main(String[] args) throws Exception {
		...
		main.run(new String[]{"-a", ".\\tamjid\\apks\\test\\" ,
						"-p", "C:\\Users\\tamji\\AppData\\Local\\Android\\Sdk\\platforms",
						"-s",  ".\\tamjid\\sourcesinks\\sourcesandsinks_wayne.txt",
//						"-o", ".\\tamjid\\output\\topfree",
						"-al", "1", "-ns"});
	}
